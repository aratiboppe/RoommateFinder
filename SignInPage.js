...
const SignInPage = () => {
  ...
  const handleSignIn = async () => {
    console.log("ENTERED FRONTEND SUCCESSFULLY");
    try {
      ...
      console.log("I AM HERE THIRD:", response.data);
      if (response.data.message === 'Incorrect Username and/or Password'){
        console.log("Invalid login information");
        Alert.alert("Login Status", "Username or passwored incorrect!");
      }
      else{
  ...
  return (
    ...
    <View style={[styles.button, styles.buttonShadowBox]} />
      ...
      <Pressable
        style={styles.signIn}
        onPress={handleSignIn}  //change this to actual page later
      >
